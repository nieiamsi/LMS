...
##​Installation
​Database Setup: Execute the SQL schema provided in the documentation to create LMS_DB and the Students table.
​Library Linking: Link the MySQL Connector include and lib folders in your compiler settings.
​DLL Placement: Ensure libmysql.dll and mysqlcppconn DLLs are in the same directory as your compiled executable.
​Audit Log: The system will automatically generate audit_log.txt upon the first grade entry.
